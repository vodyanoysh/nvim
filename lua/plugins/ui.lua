...
return {
  -- Buffer line
  {
    ...
    keys = {
      ...
      { "<leader>c", "<cmd>BufferLinePickClose<CR>", desc = "Выбрать буфер для закрытия" },
      { "<leader>bp", "<cmd>BufferLinePick<CR>", desc = "Выбрать буфер" },
    },
    opts = {
      options = {
        mode = "buffers",
